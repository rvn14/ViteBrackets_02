    ...
    <div className='fixed w-screen h-24 z-40 flex justify-center items-center backdrop-blur-xs shadow-2xs '>
        ...
        <div className='w-full h-full flex justify-center items-center text-white gap-16 lg:gap-128 '>
            ...
            {isLogged?<div className='flex items-center gap-8'>
                ...
                <Link href="/"><div className='cursor-pointer rounded-3xl nav-hover-btn'>Leaderboard</div></Link>
                <Link href="/"><div className='cursor-pointer rounded-3xl nav-hover-btn'>Players</div></Link>
                <Link href="/about"><div className='cursor-pointer rounded-3xl nav-hover-btn'>Your Team</div></Link>
