  ...
  return (
    <div className='relative w-full h-screen flex justify-center items-center'>
        ...
        <div className='w-4/5 h-full flex flex-col justify-center items-center bg-center bg-cover'>
            ...
            <Link href="/auth/signup"><div className="CTAbutton bg-gradient-to-r from-cyan-500 to-blue-500 font-semibold px-8 py-4 rounded-4xl text-white text-lg mt-7 cursor-pointer hover:scale-97 transition-all duration-500">Sign Up Now & Play Free!</div></Link>
        </div>
